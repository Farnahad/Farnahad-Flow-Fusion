...
public class HashFromFileWithKey(ICryptographyService cryptographyService) : IAction
{
    ...
    public async Task Execute(SandBox sandBox)
    {
        ...
        HashedText.Value = cryptographyService.HashFromFileWithKey(fileToHashValue, hashKeyValue, HashAlgorithm, Encoding);
