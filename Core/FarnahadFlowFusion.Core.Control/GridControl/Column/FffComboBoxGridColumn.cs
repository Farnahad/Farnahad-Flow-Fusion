...
public class FffComboBoxGridColumn : FffGridColumn
{
    public FffComboBoxGridColumn()
    {
    ...
    public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register(
        nameof(ItemsSource), typeof(object), typeof(FffComboBoxGridColumn),
    ...
    public static readonly DependencyProperty DisplayMemberProperty = DependencyProperty.Register(
        nameof(DisplayMember), typeof(string), typeof(FffComboBoxGridColumn),
    ...
    public static readonly DependencyProperty ValueMemberProperty = DependencyProperty.Register(
        nameof(ValueMember), typeof(string), typeof(FffComboBoxGridColumn),
