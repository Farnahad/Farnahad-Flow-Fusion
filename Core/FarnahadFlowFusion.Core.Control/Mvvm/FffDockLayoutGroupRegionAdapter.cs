...
public class FffDockLayoutGroupRegionAdapter : RegionAdapterBase<FffDockLayoutGroup>
{
    public FffDockLayoutGroupRegionAdapter(IRegionBehaviorFactory regionBehaviorFactory)
        : base(regionBehaviorFactory)
    {
    }

    protected override void Adapt(IRegion region, FffDockLayoutGroup regionTarget)
    {
    ...
    private FffLayoutPanel GetFffLayoutPanel(FffDockLayoutGroup fffDockLayoutGroup, FrameworkElement content)
    {
        foreach (var baseLayoutItem in fffDockLayoutGroup.Items)
        {
