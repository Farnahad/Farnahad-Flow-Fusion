...
namespace FlowFusion.Module.Core.Edit
{
        ...
        where TModelWrapper : ModelWrapper<TModel>, new()
    {
        ...
        public MeCommand SaveCommand { get; set; }
        public MeCommand DeleteCommand { get; set; }
        public MeCommand CancelCommand { get; set; }

        protected override void InitialCommands()
        {
            base.InitialCommands();

            SaveCommand = new MeCommand(Save, CanSave);
            DeleteCommand = new MeCommand(Delete, CanDelete);
            CancelCommand = new MeCommand(Cancel);
        }
        ...
        {
            return Model?.HasErrors == false && IsChanged;
        }
        ...
        //    var lookup = await _programmingLanguageLookupService.GetProgrammingLanguageLookupAsync();
